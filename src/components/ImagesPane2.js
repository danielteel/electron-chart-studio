...
export default function ImagesPane2({images, addImages, removeImage, selectedImage, setSelectedImage, clearImages}){
    ...
    return (
            <Paper variant='outlined' sx={{display: 'flex', flexDirection: 'column', maxHeight: '100%', minWidth:'300px', width: '300px', borderStyle:isDragging?'dashed':null}} onDragOver={onDragOver} onDrop={onDrop} onDragLeave={onDragLeave}>
                <Box sx={{display: 'flex'}}>
